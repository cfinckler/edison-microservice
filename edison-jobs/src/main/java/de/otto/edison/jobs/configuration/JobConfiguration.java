...
import de.otto.edison.jobs.service.JobRunSemaphoreProviderInMemImpl;
...
public class JobConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(JobRunSemaphoreProvider.class)
    public JobRunSemaphoreProvider jobRunSemaphoreProvider() {
        LOG.warn("Using dummy JobRunSemaphoreProvider");
        return new JobRunSemaphoreProviderInMemImpl();
    }
